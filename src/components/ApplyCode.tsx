...
import {
  Code2, ArrowRight, Copy, Check, Globe, MessageSquare, Lightbulb,
} from "lucide-react";
import { Skeleton } from "@/components/ui/skeleton";

const APPLY_URL = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/solana-apply-code`;
...
export function ApplyCode({
  term, wrongTerms, difficulty, mode,
  onNavigate, onOpenGraph, onExplainCode,
}: ApplyCodeProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs font-bold text-foreground">{result.title}</span>
      </div>
      ...
      <div className="bg-secondary/50 rounded-lg p-3 space-y-1">
        ...
        <p className="text-[11px] text-foreground/80 leading-relaxed">{result.explanation}</p>
      </div>
