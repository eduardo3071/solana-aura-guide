...
const translations = {
  ...
  pt: {
    ...
    "hero.subtitle": "De conceitos a código real — alimentado por um glossário inteligente.",
    ...
    "graph.subtitle": "Explore como conceitos se conectam no ecossistema Solana.",
    "notfound.title": "404",
  ...
  es: {
    ...
    "hero.subtitle": "De conceptos a código real — impulsado por un glosario inteligente.",
    ...
    "graph.subtitle": "Explora cómo se conectan los conceptos en el ecosistema Solana.",
    "notfound.title": "404",
