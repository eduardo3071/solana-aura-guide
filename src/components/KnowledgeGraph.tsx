...
export function KnowledgeGraph({ centerTerm, onSelectTerm, onClose }: KnowledgeGraphProps) {
  ...
  const graphData = useMemo(() => {
    ...
    if (nodes.length < 8) {
      const sameCat = glossary.getTermsByCategory(centerTerm.category).slice(0, 10);
