...
const translations = {
  en: {
    ...
    "quiz.description": "Test your understanding using AI-generated questions based on this concept and its relationships.",
    ...
    "quiz.insight_good": "You understand core concepts well! Try a harder difficulty.",
    "quiz.insight_review": "Review the related terms below to strengthen your understanding.",
    ...
    "apply.description": "Turn knowledge into real development — generate a practical Solana example based on your quiz results.",
  ...
  pt: {
    ...
    "quiz.description": "Teste seu entendimento com perguntas geradas por IA baseadas neste conceito e suas relações.",
    ...
    "quiz.insights": "Insights",
    "quiz.insight_good": "Você entende bem os conceitos! Tente uma dificuldade maior.",
    "quiz.insight_review": "Revise os termos abaixo para fortalecer seu entendimento.",
    ...
    "apply.description": "Transforme conhecimento em desenvolvimento real — gere um exemplo prático de Solana baseado nos seus resultados.",
  ...
  es: {
    ...
    "quiz.description": "Pon a prueba tu comprensión con preguntas generadas por IA basadas en este concepto y sus relaciones.",
    ...
    "quiz.insights": "Insights",
    "quiz.insight_good": "¡Entiendes bien los conceptos! Prueba una dificultad mayor.",
    "quiz.insight_review": "Revisa los términos abajo para fortalecer tu comprensión.",
    "quiz.review_terms": "Deberías revisar",
    "quiz.new_session": "Nueva Sesión",
    "quiz.explore_graph": "Explorar Grafo",
    // Apply Code
    "apply.title": "💻 Aplica lo que acabas de aprender",
    "apply.description": "Transforma el conocimiento en desarrollo real — genera un ejemplo práctico de Solana basado en tus resultados.",
