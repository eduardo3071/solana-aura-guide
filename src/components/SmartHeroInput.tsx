...
const PLACEHOLDER_TERMS = ["PDA", "Turbine", "Proof of History", "Validator", "SPL Token", "Anchor"];
...
export function SmartHeroInput({ onSelectTerm }: SmartHeroInputProps) {
  ...
  const dynamicPlaceholder = query ? "" : `${t("hero.input_placeholder")} "${placeholderText}|"`;
      ...
      <div className="relative">
        <div className="relative group">
          ...
          <textarea
            ...
            style={{ fontFamily: isCodeDetected ? "'JetBrains Mono', monospace" : undefined }}
          />
        </div>
